...
/**
 * Handler called when the `TokenURIUpdated` Event is called on the Tuli Media Contract
 * @param event
 */
...
/**
 * Handler called when the `TokenMetadataURIUpdated` Event is called on the Tuli Media Contract
 * @param event
 */
...
/**
 * Handler called when the `Transfer` Event is called on the Tuli Media Contract
 * @param event
 */
...
/**
 * Handler called when the `Approval` Event is called on the Tuli Media Contract
 * @param event
 */
...
/**
 * Handler called when the `ApprovalForAll` Event is called on the Tuli Media Contract
 * @param event
 */
...
/**
 * Handler called when the `Mint` Event is called on the Tuli Media Contract
 * @param event
 */
