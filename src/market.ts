...
/**
 * Handler called when a `BidShareUpdated` Event is emitted on the Tuli Market Contract
 * @param event
 */
...
/**
 * Handler called when the `AskCreated` Event is emitted on the Tuli Market Contract
 * @param event
 */
...
/**
 * Handler called when the `AskRemoved` Event is emitted on the Tuli Market Contract
 * @param event
 */
...
/**
 * Handler called `BidCreated` Event is emitted on the Tuli Market Contract
 * @param event
 */
...
/**
 * Handler called when the `BidRemoved` Event is emitted on the Tuli Market Contract
 * @param event
 */
...
/**
 * Handler called when the `BidFinalized` Event is emitted on the Tuli Market Contract
 * @param event
 */
export function handleBidFinalized(event: BidFinalized): void {
  ...
  // https://github.com/ourtuli/core/blob/master/contracts/Market.sol#L349
